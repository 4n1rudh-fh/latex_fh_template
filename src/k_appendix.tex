...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/g_results/laser_spot_dia/lsp/1mm.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/g_results/laser_spot_dia/lsp/2mm.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/g_results/laser_spot_dia/lsp/3mm.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/g_results/laser_spot_dia/lsp/5mm.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/g_results/laser_spot_dia/lsp/7mm.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/g_results/laser_spot_dia/lsp/9mm.png}
        \caption{Laser Spot Diameter: \SI{9}{\milli\meter}, \gls{mig}: 364.852}
        \label{subfig:9mm.png}
    \end{subfigure}
    \caption{\glsplural{lsp} captured for different laser spot diameters.}
