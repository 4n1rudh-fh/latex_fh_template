...
\subsection{Setup Parameters}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{C{3cm}C{3cm}C{3cm}C{3cm}}
            ...
            \bottomrule
        \end{tabular}
        \caption{\gls{lsp} collected for different laser power (Adapted from \ref{fig:song_fig9} Song et. al. 2020) \cite{song}.}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{C{3cm}C{3cm}C{3cm}C{3cm}}
            ...
            \bottomrule
        \end{tabular}
        \caption{\gls{lsp} collected under different temperatures (Adapted from Fig. \ref{fig:song_fig9} Song et. al. 2020) \cite{song}.}
