...
\noindent Change the following image.
    ...
    \begin{figure}[h]
        \hspace{3cm}
        % \centering
        \includegraphics[width=0.7\textwidth]{images/a_introduction/Pathaccuracy.png}
